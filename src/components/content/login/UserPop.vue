  ...
  <div>
    <div class="user-pop" ref="userpop">
      ...
      <ul class="userinfo-list">
        <li @click="toMyhome">
          <span><i class="iconfont icon-user"></i>个人主页</span
          ><i class="iconfont icon-xiayiye"></i>
        </li>
        <li @click="getUserRecordBy">
          <span><i class="iconfont icon-dengji"></i>听歌排行</span
          ><i class="iconfont icon-xiayiye"></i>
        </li>
        <li>
          <span><i class="iconfont icon-shezhi"></i>个人设置</span
          ><i class="iconfont icon-xiayiye"></i>
        </li>
        <li @click="logout">
...
export default {
  ...
  methods: {
    ...
    getUserDetailBy() {
      ...
      getUserDetail(this.userInfo.userId, timestamp).then((res) => {
